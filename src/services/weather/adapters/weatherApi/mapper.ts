...
export class WeatherApiStatusMapper {
    private readonly _WEATHER_API_STATUS_MAP: Record<WeatherApiIcon, WeatherStatus> = {
        ...
        mist: 'FOG',
        patchy_rain_nearby: 'LIGHT_RAIN',
        patchy_rain_possible: 'LIGHT_RAIN',
        ...
        blowing_snow: 'HEAVY_SNOW',
        blizzard: 'HEAVY_SNOW',
        fog: 'FOG',
        freezing_fog: 'FOG',
        patchy_light_drizzle: 'LIGHT_RAIN',
        light_drizzle: 'LIGHT_RAIN',
        freezing_drizzle: 'SLEET',
        heavy_freezing_drizzle: 'SLEET',
        patchy_light_rain: 'LIGHT_RAIN',
        light_rain: 'LIGHT_RAIN',
        moderate_rain_at_times: 'RAIN',
        moderate_rain: 'LIGHT_RAIN',
        heavy_rain_at_times: 'HEAVY_RAIN',
        ...
        moderate_snow: 'HEAVY_SNOW',
        patchy_heavy_snow: 'HEAVY_SNOW',
        heavy_snow: 'HEAVY_SNOW',
        ice_pellets: 'HAIL',
        light_rain_shower: 'HEAVY_RAIN',
        moderate_or_heavy_rain_shower: 'HEAVY_RAIN',
        torrential_rain_shower: 'HEAVY_RAIN',
        ...
        patchy_light_snow_with_thunder: 'HEAVY_SNOW',
        moderate_or_heavy_snow_with_thunder: 'HEAVY_SNOW',
    };
    ...
    public toStatus(status: string): WeatherStatus {
        return this._WEATHER_API_STATUS_MAP[status as WeatherApiIcon] ?? 'WARNING';
    }
}
