    ...
    return Widget.Scrollable({
        ...
        child: Widget.Box({
            ...
            children: [
                ...
                Option({ opt: options.theme.bar.buttons.style, title: 'Button Style', type: 'enum', enums: ['default', 'split', 'wave'] }),
                ...
                Option({ opt: options.theme.bar.buttons.icon_background, title: 'Button Icon Background', type: 'color' }),
                ...
                Option({ opt: options.theme.bar.buttons.windowtitle.icon_background, title: 'Button Icon Background', type: 'color' }),
                ...
                Option({ opt: options.theme.bar.buttons.media.icon_background, title: 'Button Icon Background', type: 'color' }),
                ...
                Option({ opt: options.theme.bar.buttons.volume.icon_background, title: 'Button Icon Background', type: 'color' }),
                ...
                Option({ opt: options.theme.bar.buttons.network.icon_background, title: 'Button Icon Background', type: 'color' }),
                ...
                Option({ opt: options.theme.bar.buttons.bluetooth.icon_background, title: 'Button Icon Background', type: 'color' }),
                ...
                Option({ opt: options.theme.bar.buttons.battery.icon_background, title: 'Button Icon Background', type: 'color' }),
                ...
                Option({ opt: options.theme.bar.buttons.notifications.icon_background, title: 'Button Icon Background', type: 'color' }),
            ]
        })
    })
}
