...
Forces each Monitor's Workspace labels to start from 1.`,
                ...
                Option({ opt: options.bar.windowtitle.class_name, title: 'Use Class Name', subtitle: 'Only applicable if Show Custom Title is disabled\nDisplays the window\'s class name instead of its title.', type: 'boolean' }),
