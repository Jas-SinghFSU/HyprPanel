...
Forces each Monitor's Workspace labels to start from 1.`,
                ...
                Option({ opt: options.bar.media.show_active_only, title: 'Show Active Only', subtitle: 'Button is shown only when there is an active media detected.', type: 'boolean' }),
