    ...
    return Widget.Scrollable({
        ...
        child: Widget.Box({
            ...
            children: [
                ...
                Option({ opt: options.bar.workspaces.numbered_active_indicator, title: 'Numbered Workspace Identifier', subtitle: 'Only applicable if Workspace Numbers are enabled', type: 'enum', enums: ["underline", "highlight", "color only"] }),
