...
export const BarGeneral = () => {
    return Widget.Box({
        ...
        children: [
            ...
            Option({ opt: options.theme.osd.location, title: 'Position', subtitle: 'Position', type: 'enum', enums: ["top left", "top", "top right", "right", "bottom right", "bottom", "bottom left", "left"] }),
            ...
            Option({ opt: options.theme.osd.margins, title: 'Margins', subtitle: 'Marings in the following format: top right bottom left', type: 'string' }),
        ]
    })
}
